export default {
  ...
  printabilityWarningBody: 'Almeno un bordo elemento più piccolo nel modello 3D è molto piccolo: {dimensions}. A seconda della configurazione, la stampa potrebbe risultare più difficile. ',
